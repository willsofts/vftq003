...
2. api try out, this is supported api that you have created ex. \
    curl -X POST http://localhost:8080/api/sftq003/list

This vue application using `sftq003` api to manipulate transaction. \
...
### Testing
1. Normally copy output folder after build success ex. vftq003 into [vueserve](https://github.com/willsofts/vueserve) project under public path and then you can launch it directly ex. 

    http://localhost:8080/vftq003/vftq003.html
