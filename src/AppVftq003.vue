...
<template>
  ...
  <div class="pt-page pt-page-current pt-page-controller search-pager">
    <PageHeader ref="pageHeader" :labels="labels" pid="vftq003" version="1.0.0" showLanguage="true" @language-changed="changeLanguage" :multiLanguages="multiLanguages" :build="buildVersion" :visible="displayPageHeader" />
    ...
    this.$nextTick(async () => {
      ...
      startApplication("vftq003",(data) => {
        ...
        if(data.type=="language") {
          ...
          loadAndMergeLabel("vftq003", (success) => {
            if (success) {
